...
- **Model menu (seed defaults — verify slugs before shipping):** `orchestrator=anthropic:passthrough`, `flagship=openrouter:z-ai/glm-5.2`, `max=openrouter:qwen/qwen3.7-max`, `reasoner=openrouter:deepseek/deepseek-v4-pro`, `review=openrouter:minimax/minimax-m3`, `cheap=openrouter:deepseek/deepseek-v4-flash`, `claude-review=anthropic:claude-sonnet-5`.
